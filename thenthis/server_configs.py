...
ranch_servers = {
    ...
    "remotepi": Server(
        host="192.168.1.214",
        port=8000,
        tags={"server_name": ["remotepi"], "roles": ["test"]},
    ),
    "sandpatch": Server(
        host="192.168.1.141",
        port=8000,
